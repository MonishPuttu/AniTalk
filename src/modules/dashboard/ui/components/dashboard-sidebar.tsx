...
import { BotIcon, StarIcon, VenetianMask, VideoIcon } from "lucide-react";
    ...
    <Sidebar>
      <SidebarHeader className="text-sidebar-accent-foreground">
        <Link href="/" className="flex items-center gap-2 px-2 pt-2">
          <Image src="/logo.svg" height={36} width={36} alt="AniTalk" />
          <p className="text-2xl font-semibold">AniTalk</p>
        </Link>
      </SidebarHeader>
